 ...
 *
 * All animation is pure CSS (wm-bob / wm-lstep / wm-rstep / wm-scroll) and
 * is disabled globally under `prefers-reduced-motion: reduce`.
 */
export function WalkingMachine({ scale = 1 }: { scale?: number }) {
  return (
    <div
      className="wm"
      ...
      aria-hidden="true"
    >
      <svg className="wm-legl" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20.69332" height="68.19944" viewBox="0,0,20.69332,68.19944">
        ...
        <svg className="wm-head" version="1.1" xmlns="http://www.w3.org/2000/svg" width="115.68559" height="88.29441" viewBox="0,0,115.68559,88.29441">
          <g transform="translate(-191.87889,-75.62023)">
            <g strokeMiterlimit={10}>
              ...
              />
              <path
                d="M195.31785,124.43649c0,-26.96048 21.33434,-48.81626 47.64934,-48.81626c26.316,0 47.64935,21.85578 47.64935,48.81626c0,1.03481 -0.08666,2.8866 -0.08666,2.8866c0,0 16.8538,15.99287 16.21847,17.23929c-0.66726,1.30905 -23.05667,-4.14265 -23.05667,-4.14265l-2.29866,4.5096l-7.75885,0.35623l-7.59417,6.15039l-8.64295,-1.74822l-11.70703,6.06119l-6.38599,-4.79382l-6.45999,2.36133l-7.01451,-7.38888l-8.11916,1.29382l-6.19237,-6.07265l-7.6263,-1.37795l-4.19835,-7.87062l-4.24236,-4.16907c0,0 -0.13314,-2.0999 -0.13314,-3.29458z"
                fill="#171816"
      ...
      <svg className="wm-ground" version="1.1" xmlns="http://www.w3.org/2000/svg" width="475" height="530" viewBox="0,0,163.40011,85.20095">
        <g transform="translate(-176.25,-207.64957)">
          {/* CAD construction-line ground: thin graphite strokes, no fill. */}
          <g fill="none" stroke="#6f716b" strokeWidth="1" strokeLinecap="round" strokeMiterlimit={10} opacity={0.55}>
            <path d="M209.14443,223.00182l1.34223,15.4356l-10.0667,-15.4356" />
            <path d="M198.20391,230.41806l12.95386,7.34824l6.71113,-12.08004" />
            <path d="M211.19621,238.53825l8.5262,-6.09014" />
            <path d="M317.57068,215.80173l5.27812,6.49615l0.40601,-13.39831" />
            <path d="M323.66082,222.70389l6.09014,-9.33822" />
            <path d="M180,240h160" strokeDasharray="4 4" strokeWidth={0.75} opacity={0.7} />
            <path d="M180,250h160" strokeDasharray="4 4" strokeWidth={0.75} opacity={0.5} />
          </g>
        </g>
      </svg>
    </div>
